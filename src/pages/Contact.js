...
function Contact({ handleContactClose }) {
  ...
  const sendingData = () => {
    ...
    fetch("http://127.0.0.1:8080/contact/", requestOptions)
        ...
        {isPhoneNumberFormVisible && (
          <div className="label-input-container col-12" style={{ padding: "10px", display: "flex", flex: "1" }}>
            <div>
              ...
              <input type="text" id="Primary Phone" onChange={(e) => setPhoneNumbers(e.target.value)} style={{ width: "100%", padding: "5px", boxSizing: "border-box", borderRadius: "10px", border: "1px solid rgb(229, 228, 226)", height: "5vh" }} />
            </div>
